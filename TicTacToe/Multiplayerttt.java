...
public class Multiplayerttt{
                ...
                if(Xwins == true)
                    ...
                    if(Owins == true)
                        ...
                        if(Xwins == true)
                            ...
                            if(drawRedo.equals("Y") || drawRedo.equals("YES")){
                                A1 = "_";
                                B1 = "_";
                                C1 = "_";
                                A2 = "_";
    ...
    public static void secondMove(String[] args){
        ...
        //sm = Second Move
        String smm = JOptionPane.showInputDialog(a + "\n" + b + "\n" + c + A1 + f + B1 + g + C1 + "\n" + h + "\n" + i + A2 + j + B2 + k + C2 + "\n" + l + "\n" + m + A3 + n + B3 + o + C3+"\n" + "Please Enter The Coordinate For (O)!!!");
        ...
        if(sm.equals("A1") && !A1.equals("X"))
            ...
            JOptionPane.showMessageDialog(null, sm + " is not a valid coordinate.\nEnter a new and valid coordinate.\nClick 'OK' to continue.", "Invalid Input Error.....!", 0);
            secondMove(F);
        }
    ...
    public static void fourthMove(String[] args){
        ...
        //fom = Fourth Move
        String fomm = JOptionPane.showInputDialog(a + "\n" + b + "\n" + c + A1 + f + B1 + g + C1 + "\n" + h + "\n" + i + A2 + j + B2 + k + C2 + "\n" + l + "\n" + m + A3 + n + B3 + o + C3 + "\n" + "Please Enter The Coordinates For (O)!!");
        ...
        if(fom.equals("A1") && !A1.equals("X") && !A1.equals("O"))
            ...
            JOptionPane.showMessageDialog(null, fom + " is not a valid coordinate.\nEnter a new and valid coordinate.\nClick 'OK' to continue.", "Invalid Input Error.....!", 0);
            fourthMove(F);
        }
    ...
    public static void sixthMove(String[] args){
        ...
        //sim = Sixth Move
        String simm = JOptionPane.showInputDialog(a + "\n" + b + "\n" + c + A1 + f + B1 + g + C1 + "\n" + h + "\n" + i + A2 + j + B2 + k + C2 + "\n" + l + "\n" + m + A3 + n + B3 + o + C3 + "\n" + "Please Enter The Coordinates For (O)!!");
        ...
        if(sim.equals("A1") && !A1.equals("X") && !A1.equals("O"))
            ...
            JOptionPane.showMessageDialog(null, sim + " is not a valid coordinate.\nEnter a new and valid coordinate.\nClick 'OK' to continue.", "Invalid Input Error.....!", 0);
            sixthMove(F);
        }
    ...
    public static void eighthMove(String[] args){
        ...
        //em = Eighth Move
        String emm = JOptionPane.showInputDialog(a + "\n" + b + "\n" + c + A1 + f + B1 + g + C1 + "\n" + h + "\n" + i + A2 + j + B2 + k + C2 + "\n" + l + "\n" + m + A3 + n + B3 + o + C3 + "\n" + "Please Enter The Coordinates For (O)!!");
        ...
        if(em.equals("A1") && !A1.equals("X") && !A1.equals("O"))
            ...
            JOptionPane.showMessageDialog(null, em + " is not a valid coordinate.\nEnter a new and valid coordinate.\nClick 'OK' to continue.", "Invalid Input Error.....!", 0);
            eighthMove(F);
        }
